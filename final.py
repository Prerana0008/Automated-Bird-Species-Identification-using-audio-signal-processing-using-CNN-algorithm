...
class BirdSpeciesDetectionApp(tk.Tk):
    ...
    def show_login_page(self):
        ...
        self.current_page = LoginPage(self, self.background_photo)
        self.current_page.pack(fill="both", expand=True)


class LoginPage(BasePage):
    def __init__(self, parent, background_photo):
        super().__init__(parent, background_photo, "Birds Species Identification Using Audio Signal Processing and Neural Networks - Login")
    ...
    def login(self):
        ...
        if username == "admin" and password == "admin":
            # Access the show_upload_page method from the parent BirdSpeciesDetectionApp instance
            self.parent.show_upload_page()
        else:
...
class SpectrogramDisplay(tk.Toplevel):
    def __init__(self, parent, image_path, predicted_bird):
        ...
        # Title Label
        title_label = tk.Label(self, text="Birds Species Identification Using Audio Signal Processing and Neural Networks - Output", font=("Arial", 20, "bold"))
...
class UploadPage(BasePage):
    def __init__(self, parent, background_photo):
        super().__init__(parent, background_photo, "Birds Species Identification Using Audio Signal Processing and Neural Networks - Upload")
    ...
    def predict_bird(self):
        ...
        for folder_name in os.listdir(self.spectrogram_folder):
            ...
            if os.path.exists(spectrogram_path):
                ...
                predicted_bird = folder_name.replace("_", " ").title()  # Convert folder name to title format
