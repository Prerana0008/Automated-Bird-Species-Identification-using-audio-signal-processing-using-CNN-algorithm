...
#C:\BSD\dataset\laughing_dove\XC28990 - Laughing Dove - Spilopelia senegalensis.mp3
save_path = input("Enter the path to save the spectrogram image: ")
#C:\BSD\spectrograms\laughing_dove\XC28990 - Laughing Dove - Spilopelia senegalensis.png
